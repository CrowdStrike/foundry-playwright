...
This document outlines security policy and procedures for the CrowdStrike `foundry-playwright` project.
...
+ Submitting
  a [bug](https://github.com/CrowdStrike/foundry-playwright/issues/new?assignees=&labels=bug+%3Abug%3A&template=bug_report.md&title=%5B+BUG+%5D+...).
+ Submitting a [pull request](https://github.com/CrowdStrike/foundry-playwright/pulls) to potentially resolve the issue. (New
